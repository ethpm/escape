def test_latest_version_tracking(chain, package_db):
    ...
    chain.wait.for_receipt(package_db.transact().setRelease(*v100, ''))
    ...
    assert package_db.call().getLatestMajorTree('test') == v100

    chain.wait.for_receipt(package_db.transact().release(*v110))
    ...
    assert package_db.call().getLatestVersion('test') == v110

    chain.wait.for_receipt(package_db.transact().release(*v101))
    ...
    chain.wait.for_receipt(package_db.transact().release(*v200))
    ...
    assert package_db.call().getLatestVersion('test') == v200

    chain.wait.for_receipt(package_db.transact().release(*v123))
    ...
    chain.wait.for_receipt(package_db.transact().release(*v124a1bz))
    ...
    chain.wait.for_receipt(package_db.transact().release(*v124a1ba))
